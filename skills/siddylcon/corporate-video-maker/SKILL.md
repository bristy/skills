...
version: 1.0.2
displayName: "Corporate Video Maker — Create Professional Business and Training Videos with AI"
description: >
  Corporate Video Maker — Create Professional Business and Training Videos with AI.
  The quarterly all-hands is Thursday. Marketing promised a two-minute sizzle reel of
  last quarter's wins and nobody started it. Collect the Zoom recordings, product
  screenshots, customer logos, and the CEO's selfie clip shot in the back of an Uber.
  The AI assembles a boardroom-ready presentation: consistent brand palette on every
  slide, lower-thirds identifying each speaker, tasteful instrumental underneath, and
  cuts that feel polished without screaming "template." Produce an internal edition
  with revenue figures and a public edition with those frames redacted — one project,
  two outputs. Insert chapter markers for the LMS. Bake in subtitles for the global
  workforce watching silently. Rotate the outro when a new fiscal year starts. Made
  for internal comms departments assembling town halls, HR teams building onboarding
  libraries, L&D managers converting decks into watchable modules, and agency
  producers delivering case study compilations on deadline.
...
> ⚡ Corporate Video Maker at your service! Upload a video or tell me what you're looking for.
