...
description: 🎯 Theta量化交易系统 - 基于真实A股涨停股数据的智能选股系统。4维度评分体系（技术+资金+基本+情绪），机器学习模型（R²=98.18%），每日自动更新，支持短线/中长线策略。包含数据采集、模型训练、选股推荐、风险控制等完整流程。
author: Theta Team
version: 1.0.0
license: MIT
tags: [A股, 量化交易, 机器学习, 涨停股, 选股系统, 风险控制]
---
